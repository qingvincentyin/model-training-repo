...
bucket = storage_client.bucket("vincent-ml-ops")
...
def write_metrics_to_bigquery(algo_name, training_time, model_metrics):
    ...
    table_id = "vincent-sandbox-prj.ml_ops.bank_campaign_model_metrics"
...
def main():
    input_data_path = "gs://vincent-ml-ops/bank_campaign_data/bank-additional.csv"
    model_name='xgboost'
